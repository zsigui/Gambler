...
{
    public partial class FormX469Info : Form
    {

        private static FormX469Info sInstance;

        public static FormX469Info NewInstance()
        {
            if (sInstance == null)
            {
                sInstance = new FormX469Info();
            } else
            {
                sInstance.Focus();
            }
        ...
        public void Show(X469Client client)
        {
            _client = client;
            Show();
        }
        ...
        {
            X469DialogConfirm dialog = X469DialogConfirm.newInstance();
            dialog.Show();
            if (RB_Whole.Checked)
            {
