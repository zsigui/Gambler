...
public class ImagePreProcess2 {
	...
	public static List<BufferedImage> splitImage(BufferedImage img)
		...
		for (int i = 0; i < weightlist.size();) {
			...
			System.out.println("" + i + ": " + weightlist.get(i) + ", len = "+ length);
	...
	public static void downloadImage() {
		...
		for (int i = 0; i < 30; i++) {
			getMethod = new GetMethod("http://www.1559501.com/verifycode.do?timestamp=" + System.currentTimeMillis());
			try {
				// 执行getMethod
				...
				OutputStream outStream = new FileOutputStream(new File("img2", i + ".jpg"));
